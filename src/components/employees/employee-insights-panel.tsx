...
export function EmployeeInsightsPanel({ analytics }: EmployeeInsightsPanelProps) {
  ...
  return (
    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
      ...
      <div className="rounded-lg border border-border bg-card p-5">
        <h3 className="text-sm font-medium text-muted-foreground mb-4">{t("topServices")}</h3>
