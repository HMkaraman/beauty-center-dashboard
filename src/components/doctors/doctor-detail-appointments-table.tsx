...
export function DoctorDetailAppointmentsTable({ data, onStatusChange, onDelete }: DoctorDetailAppointmentsTableProps) {
      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="border-b border-border">
            ...
            <th className="px-4 py-3 text-start text-xs font-medium text-muted-foreground">{t("patient")}</th>
            <th className="px-4 py-3 text-start text-xs font-medium text-muted-foreground">{t("procedure")}</th>
        ...
        <tbody>
          {data.map((appointment) => (
            <tr key={appointment.id} className="border-b border-border last:border-0 hover:bg-secondary/20 transition-colors">
              ...
              <td className="px-4 py-3 text-foreground">{appointment.clientName}</td>
